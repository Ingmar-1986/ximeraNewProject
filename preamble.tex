...
\pgfplotsset{compat=1.16} % suggestie compiler
...
\newcommand{\choiceTrue}{{\wordChoice{\choice[correct]{Juist}\choice{Fout}}\ }}
\newcommand{\choiceFalse}{{\wordChoice{\choice{Juist}\choice[correct]{Fout}}\ }}

\newcommand{\choiceYes}{{\wordChoice{\choice[correct]{Ja}\choice{Nee}}\ }}
\newcommand{\choiceNo}{{\wordChoice{\choice{Ja}\choice[correct]{Nee}}\ }}
...
\ifdefined\isXourse % Dit wordt verondersteld gedefinieerd te zijn in een xourse
\else
\pdfOnly{
	\usepackage{#1/printstyle} % mag enkel geinclude worden als je die apart compileert
    %\usepackage{#1/printstyle_md} % om mdframed ipv tcolorbox environments te gebruiken
}
\fi}
